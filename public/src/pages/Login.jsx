    ...
    async function handleSubmit(event){
        ...
        if(handleValidation()){
            ...
            if(data.status === true){
                ...
                localStorage.setItem("chat-app-user",JSON.stringify(data.user_));
                navigate("/");
            }
        }
    }
        ...
        {/* <> short hand for React Fragment. Used to wrap elemnts by avoiding dom node */}
            <FormContainer>
                <form onSubmit={handleSubmit}>
                   ...
                   <input type="text" placeholder="Enter Mask Id or Email" name="username" onChange={handleChange} min="3"></input>
